...
def _entry(host: str = "10.0.0.1", port: int = 443, app: str = "https", version: str | None = "1.24") -> InventoryEntry:
...
def test_asset_inventory_creation() -> None:
    inventory = AssetInventory(host="10.0.0.1", entries=(_entry(port=443), _entry(port=22, app="ssh")))
...
def test_asset_inventory_version_of() -> None:
    inventory = AssetInventory(host="10.0.0.1", entries=(_entry(port=22, app="ssh", version="9.6p1"),))
